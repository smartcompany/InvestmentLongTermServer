...
function buildSystemInstruction(
  ...
  return [
    ...
    '헤드라인·불릿 앞에 이모지를 최대 1개만 쓰세요. 이모지만 나열하지 마세요. 예: 🔥 강세, 🌊 출렁, 👀 관망.',
    ...
    'todayHeadline: 내 보유 자산 관점의 오늘 한 줄 요약(텍스트 필수). 앞에 이모지 최대 1개 + 핵심 **볼드**. 이모지만 나열 금지.',
    'marketSummary: 내 보유 자산들의 최근 트렌드·흐름 2~4문장. 전체 시장 총평 금지. 핵심 **볼드**.',
    'assetConditions: 요청된 보유 자산마다 1개씩(최대 12개). assetId는 요청의 자산ID 그대로.',
    'holdingsFocus: 각 보유 자산(또는 핵심 2~4개)에 대한 구체 포인트. 일반론 금지. 앞에 이모지 1개 + 핵심 **볼드**.',
    'nearTermOutlook: 내 보유 자산 기준 향후 며칠~몇 주 가능성 2~4문장.',
    'watchPoints: 내 보유와 직접 관련된 지켜볼 점 2~4개. 앞에 👀/⚠️ 등 이모지 1개 + 핵심 **볼드**.',
  ].join('\n');
}
